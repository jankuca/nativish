...
(function($){
  $.fn.anim = function(properties, duration, ease){
    var transforms = [], opacity, key, keys = ['opacity', '-webkit-transform'];
    ...
    return this.css({
      '-webkit-transition-property': keys.join(', '),
      '-webkit-transition-duration': (duration !== undefined ? duration : 0.5) + 's',
